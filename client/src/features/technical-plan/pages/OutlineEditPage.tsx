...
function OutlineEditPage({
  ...
  }, [generationDialogOpen, isExpansionWorkflow, outlineMode, outlineExpansionMode, outlineWordControlOptions, customOutlineFile, referenceKnowledgeDocumentIds]);
